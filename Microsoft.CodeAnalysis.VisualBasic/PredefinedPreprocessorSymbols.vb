...
Namespace Microsoft.CodeAnalysis.VisualBasic
    Public Module PredefinedPreprocessorSymbols
        ...
        Public Function AddPredefinedPreprocessorSymbols(kind As OutputKind, symbols As ImmutableArray(Of KeyValuePair(Of String, Object))) As ImmutableArray(Of KeyValuePair(Of String, Object))
            ...
            If symbols.FirstOrDefault(Function(entry) CaseInsensitiveComparison.Equals(entry.Key, CompilerVersionSymbol)).Key Is Nothing Then
            ...
            If symbols.FirstOrDefault(Function(entry) CaseInsensitiveComparison.Equals(entry.Key, TargetSymbol)).Key Is Nothing Then
