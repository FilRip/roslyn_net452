...
#nullable enable
        ...
        internal static ControlFlowGraph CreateCore(IOperation operation, string argumentNameForException, CancellationToken cancellationToken)
        {
            ...
            {
                throw new ArgumentException(Properties.Resources.NotARootOperation, argumentNameForException);
            }

            if (((Operation)operation).OwningSemanticModel == null)
            {
                throw new ArgumentException(Properties.Resources.OperationHasNullSemanticModel, argumentNameForException);
            }
