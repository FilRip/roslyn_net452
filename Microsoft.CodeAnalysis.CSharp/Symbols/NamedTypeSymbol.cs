...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    /// </summary>
    public abstract partial class NamedTypeSymbol : TypeSymbol, INamedTypeSymbolInternal
    {
        ...
        internal NamedTypeSymbol Construct(ImmutableArray<TypeWithAnnotations> typeArguments, bool unbound)
        {
            ...
            {
                throw new InvalidOperationException(Properties.Resources.CannotCreateConstructedFromConstructed);
            }

            if (this.Arity == 0)
            {
                throw new InvalidOperationException(Properties.Resources.CannotCreateConstructedFromNongeneric);
            }
            ...
            {
                throw new ArgumentException(Properties.Resources.TypeArgumentCannotBeNull, nameof(typeArguments));
            }

            if (typeArguments.Length != this.Arity)
            {
                throw new ArgumentException(Properties.Resources.WrongNumberOfTypeArguments, nameof(typeArguments));
            }
