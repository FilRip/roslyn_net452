...
namespace Microsoft.CodeAnalysis.CSharp
{
    public static partial class SyntaxFacts
    {
        ...
        public static bool IsAttributeTargetSpecifier(SyntaxKind kind)
        {
            return kind switch
            {
                SyntaxKind.AssemblyKeyword or SyntaxKind.ModuleKeyword => true,
                _ => false,
            };
        }
        ...
        internal static bool IsLiteral(SyntaxKind kind)
        {
            return kind switch
            {
                SyntaxKind.IdentifierToken or SyntaxKind.StringLiteralToken or SyntaxKind.CharacterLiteralToken or SyntaxKind.NumericLiteralToken or SyntaxKind.XmlTextLiteralToken or SyntaxKind.XmlTextLiteralNewLineToken or SyntaxKind.XmlEntityLiteralToken => true,//case SyntaxKind.Unknown:
                _ => false,
            };
        }
        ...
        public static bool IsPreprocessorDirective(SyntaxKind kind)
        {
            return kind switch
            {
                SyntaxKind.IfDirectiveTrivia or SyntaxKind.ElifDirectiveTrivia or SyntaxKind.ElseDirectiveTrivia or SyntaxKind.EndIfDirectiveTrivia or SyntaxKind.RegionDirectiveTrivia or SyntaxKind.EndRegionDirectiveTrivia or SyntaxKind.DefineDirectiveTrivia or SyntaxKind.UndefDirectiveTrivia or SyntaxKind.ErrorDirectiveTrivia or SyntaxKind.WarningDirectiveTrivia or SyntaxKind.LineDirectiveTrivia or SyntaxKind.PragmaWarningDirectiveTrivia or SyntaxKind.PragmaChecksumDirectiveTrivia or SyntaxKind.ReferenceDirectiveTrivia or SyntaxKind.LoadDirectiveTrivia or SyntaxKind.BadDirectiveTrivia or SyntaxKind.ShebangDirectiveTrivia or SyntaxKind.NullableDirectiveTrivia => true,
                _ => false,
            };
        }
        ...
        public static SyntaxKind GetOperatorKind(string operatorMetadataName)
        {
            return operatorMetadataName switch
            {
                ...
                WellKnownMemberNames.ExplicitConversionName => SyntaxKind.ExplicitKeyword,
