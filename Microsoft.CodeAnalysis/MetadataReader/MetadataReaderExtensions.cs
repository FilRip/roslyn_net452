...
namespace Microsoft.CodeAnalysis
{
    internal static class MetadataReaderExtensions
    {
            ...
            bool isReference)
        {
            ...
            {
                throw new BadImageFormatException(string.Format(Properties.Resources.InvalidAssemblyName, nameStr));
            }
            ...
            {
                throw new BadImageFormatException(string.Format(Properties.Resources.InvalidCultureName, cultureName));
            }
            ...
            if (isReference)
            {
                ...
                if (hasPublicKey)
                {
                    ...
                    {
                        throw new BadImageFormatException(Properties.Resources.InvalidPublicKey);
                    }
                }
                else
                {
                    ...
                    {
                        throw new BadImageFormatException(Properties.Resources.InvalidPublicKeyToken);
                    }
                }
            }
            else
