...
lAgain:
            ...
            Dim symbols = ArrayBuilder(Of Symbol).GetInstance
            CollectCrefNameSymbolsStrict(name, argCount, New Dictionary(Of String, CrefTypeParameterSymbol)(CaseInsensitiveComparison.Comparer), symbols, preserveAliases, useSiteInfo)
            ...
            If symbols.Count = 1 AndAlso checkForColorColor Then
                ...
                If type IsNot Nothing Then
                    If CaseInsensitiveComparison.Equals(type.Name, nameText) Then
        ...
        Private Sub CollectSimpleNameSymbolsStrict(node As SimpleNameSyntax,
            ...
            Else
                ...
                If CaseInsensitiveComparison.Equals(identifier.Identifier.ValueText, SyntaxFacts.GetText(SyntaxKind.NewKeyword)) AndAlso Not token.IsBracketed Then
            ...
            Select Case containingSymbol.Kind
                ...
                Case SymbolKind.Property
                    If allowColorColor Then
                        ...
                        If CaseInsensitiveComparison.Equals([property].Name, propertyType.Name) Then
                ...
                Case SymbolKind.Field
                    If allowColorColor Then
                        ...
                        If CaseInsensitiveComparison.Equals(field.Name, fieldType.Name) Then
                ...
                Case SymbolKind.Method
                    ...
                    If allowColorColor Then
                        ...
                        If Not method.IsSub Then
                            ...
                            If CaseInsensitiveComparison.Equals(method.Name, returnType.Name) Then
