...
#End Region
        ...
        Public Overrides Function IsSystemTypeReference(type As ITypeSymbolInternal) As Boolean
        ...
        Public Overrides Function CommonGetWellKnownTypeMember(member As WellKnownMember) As ISymbolInternal
            Return GetWellKnownTypeMember(member)
        End Function

        Public Overrides Function CommonGetWellKnownType(wellknownType As WellKnownType) As ITypeSymbolInternal
            Return GetWellKnownType(wellknownType)
        End Function

        Public Overrides Function IsAttributeType(type As ITypeSymbol) As Boolean
