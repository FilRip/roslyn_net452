...
namespace Microsoft.CodeAnalysis.Operations
{
    public static class OperationFactory
    {
        ...
        {
            public CommonConversion ToCommonConversion() => new(exists: true, isIdentity: true, isNumeric: false, isReference: false, methodSymbol: null, isImplicit: true, isNullable: false);
        }
    }
}
