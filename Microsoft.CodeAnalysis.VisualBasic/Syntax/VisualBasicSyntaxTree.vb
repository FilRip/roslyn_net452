...
#Enable Warning BC40000
        ...
        Public Overrides Function GetMappedLineSpanAndVisibility(span As TextSpan, ByRef isHiddenPosition As Boolean) As FileLinePositionSpan
        ...
        Public Overrides Function GetLineMappings(Optional cancellationToken As CancellationToken = Nothing) As IEnumerable(Of LineMapping)
            ...
            Return If(map.Entries.Length = 1, New LineMapping(0), map.GetLineMappings(GetText(cancellationToken).Lines))
        End Function
