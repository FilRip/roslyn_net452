    ...
    public sealed partial class ObjectWriter : IDisposable
    {
        ...
        public void WriteValue(object? value)
        {
            ...
            else if (type.IsArray)
            {
                ...
                if (instance.Rank > 1)
                {
                    throw new InvalidOperationException(Microsoft.CodeAnalysis.Properties.Resources.Arrays_with_more_than_one_dimension_cannot_be_serialized);
                }
        ...
        internal void WriteCompressedUInt(uint value)
        {
            ...
            {
                throw new ArgumentException(Microsoft.CodeAnalysis.Properties.Resources.Value_too_large_to_be_represented_as_a_30_bit_unsigned_integer);
            }
        }
