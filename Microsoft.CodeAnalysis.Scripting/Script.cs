...
namespace Microsoft.CodeAnalysis.Scripting
{
    ...
    public abstract class Script
    {
        ...
        public readonly ScriptBuilder Builder;
        ...
        public static Script<T> CreateInitialScript<T>(ScriptCompiler compiler, SourceText sourceText, ScriptOptions optionsOpt, Type globalsTypeOpt, InteractiveAssemblyLoader assemblyLoaderOpt)
        {
        ...
        /// </summary>
        public ImmutableArray<MetadataReference> GetReferencesForCompilation(
    ...
    public sealed class Script<T> : Script
    {
        ...
        public new Task<ScriptState<T>> RunFromAsync(ScriptState previousState, Func<Exception, bool> catchException = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                throw new ArgumentException(Properties.Resources.StartingStateIncompatible, nameof(previousState));
            }
        ...
        private static void ValidateGlobals(object globals, Type globalsType)
        {
            if (globalsType != null)
            {
                if (globals == null)
                {
                    throw new ArgumentException(Properties.Resources.ScriptRequiresGlobalVariables, nameof(globals));
                }
                ...
                {
                    throw new ArgumentException(string.Format(Properties.Resources.GlobalsNotAssignable, runtimeType, globalsTypeInfo), nameof(globals));
                }
            }
            else if (globals != null)
            {
                throw new ArgumentException(Properties.Resources.GlobalVariablesWithoutGlobalType, nameof(globals));
            }
        }
    }
}
