...
Namespace Microsoft.CodeAnalysis.VisualBasic
    ...
    Public NotInheritable Class VisualBasicCompilationOptions
        ...
        Public Overrides Function GetImports() As ImmutableArray(Of String)
        ...
        Public Overrides Function FilterDiagnostic(diagnostic As Diagnostic, cancellationToken As CancellationToken) As Diagnostic
