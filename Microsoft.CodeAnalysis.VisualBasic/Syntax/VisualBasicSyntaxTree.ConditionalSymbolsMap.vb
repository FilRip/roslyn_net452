...
#Region "Build conditional symbols map"
            ...
            Private Class ConditionalSymbolsMapBuilder
                ...
                Friend Function Build(root As SyntaxNodeOrToken, options As VisualBasicParseOptions) As ImmutableDictionary(Of String, Stack(Of Tuple(Of InternalSyntax.CConst, Integer)))
                    Me._conditionalsMap = New Dictionary(Of String, Stack(Of Tuple(Of InternalSyntax.CConst, Integer)))(CaseInsensitiveComparison.Comparer)
                    ...
                    Return If(Me._conditionalsMap.Any(), ImmutableDictionary.CreateRange(CaseInsensitiveComparison.Comparer, Me._conditionalsMap), Nothing)
                End Function
...
#End Region
            ...
            Friend Function GetPreprocessingSymbolInfo(conditionalSymbolName As String, node As IdentifierNameSyntax) As VisualBasicPreprocessingSymbolInfo
                ...
                Dim symbolName = _conditionalsMap.Keys.First(Function(key) CaseInsensitiveComparison.Equals(key, conditionalSymbolName))
