...
namespace Microsoft.CodeAnalysis.Collections
{
    ...
    internal readonly struct SegmentedArray<T> : ICloneable, IList, IStructuralComparable, IStructuralEquatable, IList<T>, IReadOnlyList<T>
    {
        ...
        {
            throw new NotSupportedException(Properties.Resources.NotSupported_FixedSizeCollection);
        }
        ...
        int IStructuralComparable.CompareTo(object? other, IComparer comparer)
        {
            ...
            if (other is not SegmentedArray<T> o
                || Length != o.Length)
            {
                throw new ArgumentException(Properties.Resources.ArgumentException_OtherNotArrayOfCorrectLength, nameof(other));
            }
