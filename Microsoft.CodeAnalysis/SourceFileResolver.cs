...
namespace Microsoft.CodeAnalysis
{
    ...
    public class SourceFileResolver : SourceReferenceResolver, IEquatable<SourceFileResolver>
    {
            ...
            ImmutableArray<KeyValuePair<string, string>> pathMap)
        {
            ...
            {
                throw new ArgumentException(Properties.Resources.AbsolutePathExpected, nameof(baseDirectory));
            }
            ...
            if (!pathMap.IsDefaultOrEmpty)
            {
                ...
                foreach (var (key, value) in pathMap)
                {
                    ...
                    {
                        throw new ArgumentException(Properties.Resources.EmptyKeyInPathMap, nameof(pathMap));
                    }

                    if (value == null)
                    {
                        throw new ArgumentException(Properties.Resources.NullValueInPathMap, nameof(pathMap));
                    }
