...
Namespace Microsoft.CodeAnalysis.VisualBasic.Symbols
    ...
    Friend MustInherit Class SourceMemberContainerTypeSymbol
        ...
        Private Shared ReadOnly s_emptyTypeMembers As New Dictionary(Of String, ImmutableArray(Of NamedTypeSymbol))(CaseInsensitiveComparison.Comparer)
...
#Region "Members (phase 5)"
        ...
        Friend NotInheritable Class MembersAndInitializersBuilder
            ...
            Friend Function ToReadOnlyAndFree() As MembersAndInitializers
                ...
                Dim readonlyMembers = New Dictionary(Of String, ImmutableArray(Of Symbol))(CaseInsensitiveComparison.Comparer)
...
#End If
        ...
        Friend Overrides Function GetSimpleNonTypeMembers(name As String) As ImmutableArray(Of Symbol)
            If _lazyMembersAndInitializers IsNot Nothing OrElse MemberNames.Contains(name, CaseInsensitiveComparison.Comparer) Then
        ...
        Private Function CheckForOperatorOverloadingErrors(
            ...
            If methodMethodKind = MethodKind.Conversion Then
                Dim otherName As String = If(CaseInsensitiveComparison.Equals(WellKnownMemberNames.ImplicitConversionName, method.Name),
