...
Namespace Microsoft.CodeAnalysis.VisualBasic.Symbols
    ...
    Friend MustInherit Class MergedNamespaceSymbol
        ...
        Private Sub New(containingNamespace As MergedNamespaceSymbol, namespacesToMerge As ImmutableArray(Of NamespaceSymbol))
            ...
            Me._cachedLookup = New CachingDictionary(Of String, Symbol)(AddressOf SlowGetChildrenOfName, AddressOf SlowGetChildNames, CaseInsensitiveComparison.Comparer)
        End Sub
...
#If DEBUG Then
                ...
                For Each ns In namespacesToMerge
                    ...
                    Debug.Assert(CaseInsensitiveComparison.Equals(name, ns.Name))
                Next
#End If
