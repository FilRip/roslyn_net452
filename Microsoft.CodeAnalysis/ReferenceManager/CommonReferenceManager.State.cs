...
namespace Microsoft.CodeAnalysis
{
    ...
    public partial class CommonReferenceManager<TCompilation, TAssemblySymbol> : CommonReferenceManager
    {
        ...
        public IDictionary<(string, string), MetadataReference> ReferenceDirectiveMap
        {
            get
            {
                AssertBound();
            ...
            for (int i = 0; i < originalIdentities.Length; i++)
            {
                ...
                if (versionPattern is object)
                {
                    ...
                    if (lazyBuilder.ContainsKey(sourceIdentity))
                    {
                        ...
                        throw new NotSupportedException(Properties.Resources.CompilationReferencesAssembliesWithDifferentAutoGeneratedVersion);
                    }
