...
namespace Microsoft.CodeAnalysis.CSharp.Syntax.InternalSyntax
{
    public sealed class InterfaceDeclarationSyntax : TypeDeclarationSyntax
    {
        ...
        {
            return new InterfaceDeclarationSyntax(base.Kind, attributeLists, modifiers, keyword, identifier, typeParameterList, baseList, constraintClauses, openBraceToken, members, closeBraceToken, semicolonToken, diagnostics, GetAnnotations());
        }

        public override GreenNode SetAnnotations(SyntaxAnnotation[]? annotations)
        {
            return new InterfaceDeclarationSyntax(base.Kind, attributeLists, modifiers, keyword, identifier, typeParameterList, baseList, constraintClauses, openBraceToken, members, closeBraceToken, semicolonToken, GetDiagnostics(), annotations);
        }

        public InterfaceDeclarationSyntax(ObjectReader reader)
            : base(reader)
        {
            base.SlotCount = 11;
        ...
        {
            ObjectBinder.RegisterTypeReader(typeof(InterfaceDeclarationSyntax), (ObjectReader r) => new InterfaceDeclarationSyntax(r));
        }
    }
}
