...
namespace Microsoft.CodeAnalysis.Scripting.Hosting
{
    ...
    public static class ObjectFormatterHelpers
    {
        ...
        public static ObjectDisplayOptions GetObjectDisplayOptions(bool useQuotes = false, bool escapeNonPrintable = false, bool includeCodePoints = false, int numberRadix = NumberRadixDecimal)
        {
