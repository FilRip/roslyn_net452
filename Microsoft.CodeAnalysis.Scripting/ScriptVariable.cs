    ...
    public sealed class ScriptVariable
    {
        ...
        public object Value
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidOperationException(Properties.Resources.CannotSetReadOnlyVariable);
                }

                if (_field.IsLiteral)
                {
                    throw new InvalidOperationException(Properties.Resources.CannotSetConstantVariable);
                }
