...
namespace Microsoft.CodeAnalysis.Scripting.Hosting
{
    public sealed class CommandLineRunner
    {
        ...
        public CommandLineRunner(ConsoleIO console, CommonCompiler compiler, ScriptCompiler scriptCompiler, ObjectFormatter objectFormatter)
        {
        ...
        private int RunInteractiveCore(ErrorLogger errorLogger)
        {
            ...
            if (sourceFiles.IsEmpty && _compiler.Arguments.DisplayLogo)
            {
                ...
                {
                    _console.Out.WriteLine(Properties.Resources.HelpPrompt);
                }
            }
        ...
        public static MetadataReferenceResolver GetMetadataReferenceResolver(CommandLineArguments arguments, TouchedFileLogger loggerOpt)
        {
        ...
        {
            _console.Out.Write(Properties.Resources.HelpText);
        ...
        private void DisplayDiagnostics(ImmutableArray<Diagnostic> diagnostics)
        {
            ...
            try
            {
                ...
                if (diagnostics.Length > MaxDisplayCount)
                {
                    ...
                    _console.Error.WriteLine(string.Format(Properties.Resources.PlusAdditionalError, notShown));
                }
            }
            finally
            {
