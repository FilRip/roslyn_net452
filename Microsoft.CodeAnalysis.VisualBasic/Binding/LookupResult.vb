            ...
            Function(syms As ImmutableArray(Of Symbol)) As AmbiguousSymbolDiagnostic
                ...
                If container.Name.Length > 0 Then
                    Dim containers = syms.Select(Function(sym) sym.ContainingSymbol).
                                     GroupBy(Function(c) c.ToDisplayString(SymbolDisplayFormat.QualifiedNameOnlyFormat), CaseInsensitiveComparison.Comparer).
                                     OrderBy(Function(group) group.Key, CaseInsensitiveComparison.Comparer).
