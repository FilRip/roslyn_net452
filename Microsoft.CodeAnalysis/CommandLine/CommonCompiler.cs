...
#nullable enable
        ...
        public virtual int Run(TextWriter consoleOutput, CancellationToken cancellationToken = default)
        {
            ...
            {
                Thread.CurrentThread.CurrentCulture = saveUICulture;
                errorLogger?.Dispose();
            }
        }
        ...
        protected virtual Compilation RunGenerators(Compilation input, ParseOptions parseOptions, ImmutableArray<ISourceGenerator> generators, AnalyzerConfigOptionsProvider analyzerConfigOptionsProvider, ImmutableArray<AdditionalText> additionalTexts, DiagnosticBag generatorDiagnostics) { return input; }
...
#nullable enable
            ...
            consoleOutput.WriteLine(string.Format(Properties.Resources.AnalyzerTotalExecutionTime, getFormattedTime(totalAnalyzerExecutionTime)));

            if (isConcurrentBuild)
            {
                consoleOutput.WriteLine(Properties.Resources.MultithreadedAnalyzerExecutionNote);
            }
            ...
            var analyzerNameColumn = getFormattedAnalyzerName(Properties.Resources.AnalyzerNameColumnHeader);
