...
Namespace Microsoft.CodeAnalysis.VisualBasic.Symbols
    ...
    Friend Class QuickAttributeChecker
        ...
        Public Sub New()
            _nameToAttributeMap = New Dictionary(Of String, QuickAttributes)(CaseInsensitiveComparison.Comparer)
        End Sub

        Public Sub New(other As QuickAttributeChecker)
            _nameToAttributeMap = New Dictionary(Of String, QuickAttributes)(other._nameToAttributeMap, CaseInsensitiveComparison.Comparer)
        End Sub
