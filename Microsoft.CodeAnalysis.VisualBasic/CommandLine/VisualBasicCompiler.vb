...
Namespace Microsoft.CodeAnalysis.VisualBasic
    ...
    Friend MustInherit Class VisualBasicCompiler
        ...
        Public Overrides Function SuppressDefaultResponseFile(args As IEnumerable(Of String)) As Boolean
        ...
        Public Overrides Function GetToolName() As String
        ...
        Protected Overrides Function RunGenerators(input As Compilation, parseOptions As ParseOptions, generators As ImmutableArray(Of ISourceGenerator), analyzerConfigOptionsProvider As AnalyzerConfigOptionsProvider, additionalTexts As ImmutableArray(Of AdditionalText), diagnostics As DiagnosticBag) As Compilation
