...
#Region "Constructors and Factories"
        ...
        ''' </summary>
        Public Overrides Function WithSemanticModelProvider(semanticModelProvider As SemanticModelProvider) As Compilation
        ...
        Public Overrides Sub SerializePdbEmbeddedCompilationOptions(builder As BlobBuilder)
...
#Region "Syntax Trees"
            ...
            Try
                ...
                For Each tree As SyntaxTree In trees
                    ...
                    If tree.IsEmbeddedOrMyTemplateTree() Then
                        Throw New ArgumentException(My.Resources.CannotAddCompilerSpecialTree)
                    End If
                ...
                If IsSubmission AndAlso declMap.Count > 1 Then
                    Throw New ArgumentException(My.Resources.SubmissionCanHaveAtMostOneSyntaxTree, NameOf(trees))
                End If
        ...
        Public Shadows Function RemoveSyntaxTrees(trees As IEnumerable(Of SyntaxTree)) As VisualBasicCompilation
            ...
            For Each tree As SyntaxTree In trees
                If tree.IsEmbeddedOrMyTemplateTree() Then
                    Throw New ArgumentException(My.Resources.CannotRemoveCompilerSpecialTree)
                End If
        ...
        Public Shadows Function ReplaceSyntaxTree(oldTree As SyntaxTree, newTree As SyntaxTree) As VisualBasicCompilation
            ...
            If Not newTree.HasCompilationUnitRoot Then
                Throw New ArgumentException(My.Resources.TreeMustHaveARootNodeWithCompilationUnit, NameOf(newTree))
            End If
            ...
            If declMap.ContainsKey(vbNewTree) Then
                Throw New ArgumentException(My.Resources.SyntaxTreeAlreadyPresent, NameOf(newTree))
            End If
        ...
        ''' </summary>
        Public Overrides Function CompareSourceLocations(first As Location, second As Location) As Integer
        ...
        ''' Can be used to get a total ordering on declarations, for example.
        ''' </summary>
        Public Overrides Function CompareSourceLocations(first As SyntaxReference, second As SyntaxReference) As Integer
            Return LexicalSortKey.Compare(first, second, Me)
        End Function

        Public Overrides Function GetSyntaxTreeOrdinal(tree As SyntaxTree) As Integer
...
#Region "References"
        ...
        Protected Overrides Function CommonGetMetadataReference(assemblySymbol As IAssemblySymbol) As MetadataReference
        ...
        Public Overrides ReadOnly Property ReferenceDirectives As IEnumerable(Of ReferenceDirective)
            Get
...
#Region "Symbols"
        ...
        Public Overrides Sub ReportUnusedImports(diagnostics As DiagnosticBag, cancellationToken As CancellationToken)
        ...
        Public Overrides Sub CompleteTrees(filterTree As SyntaxTree)
        ...
        Public Overrides Function ClassifyConvertibleConversion(source As IOperation, destination As ITypeSymbol, ByRef constantValue As ConstantValue) As IConvertibleConversion
        ...
        Public Overrides Function CommonGetSpecialTypeMember(specialMember As SpecialMember) As ISymbolInternal
        ...
        Protected Overrides Function IsSymbolAccessibleWithinCore(symbol As ISymbol, within As ISymbol, throughType As ITypeSymbol) As Boolean
...
#Region "Binding"
        ...
        Public Overrides Function CreateSemanticModel(syntaxTree As SyntaxTree, ignoreAccessibility As Boolean) As SemanticModel
...
#Region "Diagnostics"
        ...
        Public Overrides Sub GetDiagnostics(stage As CompilationStage,
            ...
            If (stage = CompilationStage.Parse OrElse stage > CompilationStage.Parse AndAlso includeEarlierStages) Then
                ...
                For Each tree In SyntaxTrees
                    ...
                    If Not tree.Options.Errors.IsDefaultOrEmpty AndAlso parseOptionsReported.Add(tree.Options) Then
                        ...
                        For Each Err As Diagnostic In tree.Options.Errors
...
#Enable Warning S1481 ' Unused local variables should be removed
        ...
        Public Overrides Function CreateAnalyzerDriver(analyzers As ImmutableArray(Of DiagnosticAnalyzer), analyzerManager As AnalyzerManager, severityFilter As SeverityFilter) As AnalyzerDriver
...
#Region "Emit"
        ...
        Public Overrides ReadOnly Property LinkerMajorVersion As Byte
            Get
                Return &H50
            End Get
        End Property

        Public Overrides ReadOnly Property IsDelaySigned As Boolean
            Get
                Return SourceAssembly.IsDelaySigned
            End Get
        End Property

        Public Overrides ReadOnly Property StrongNameKeys As StrongNameKeys
            Get
                Return SourceAssembly.StrongNameKeys
            End Get
        End Property

        Public Overrides Function CreateModuleBuilder(
        ...
        Public Overrides Function CompileMethods(
        ...
        Public Overrides Function GenerateResourcesAndDocumentationComments(
            moduleBuilder As CommonPEModuleBuilder,
...
#Region "Common Members"
        ...
        Protected Overrides Function CommonGetSpecialType(specialType As SpecialType) As INamedTypeSymbolInternal
        ...
        Protected Overrides Function CommonCreatePointerTypeSymbol(elementType As ITypeSymbol) As IPointerTypeSymbol
            Throw New NotSupportedException(My.Resources.ThereAreNoPointerTypesInVB)
        End Function
        ...
        Protected Overrides Function CommonCreateFunctionPointerTypeSymbol(
            ...
            Throw New NotSupportedException(My.Resources.ThereAreNoFunctionPointerTypesInVB)
        End Function

        Protected Overrides Function CommonCreateNativeIntegerTypeSymbol(signed As Boolean) As INamedTypeSymbol
            Throw New NotSupportedException(My.Resources.ThereAreNoNativeIntegerTypesInVB)
        End Function
        ...
        Protected Overrides ReadOnly Property CommonDynamicType As ITypeSymbol
            Get
                Throw New NotSupportedException(My.Resources.ThereIsNoDynamicTypeInVB)
            End Get
        End Property
        ...
        Public Overrides Function ContainsSymbolsWithName(predicate As Func(Of String, Boolean), Optional filter As SymbolFilter = SymbolFilter.TypeAndMember, Optional cancellationToken As CancellationToken = Nothing) As Boolean
            ...
            If filter = SymbolFilter.None Then
                Throw New ArgumentException(My.Resources.NoNoneSearchCriteria, NameOf(filter))
            End If
