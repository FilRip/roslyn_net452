...
#nullable enable
            ...
            AssemblyContentType contentType = AssemblyContentType.Default)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(contentType), Properties.Resources.InvalidContentType);
            }

            if (!IsValidName(name))
            {
                throw new ArgumentException(string.Format(Properties.Resources.InvalidAssemblyName, name), nameof(name));
            }

            if (!IsValidCultureName(cultureName))
            {
                throw new ArgumentException(string.Format(Properties.Resources.InvalidCultureName, cultureName), nameof(cultureName));
            }
            ...
            if (hasPublicKey)
            {
                ...
                {
                    throw new ArgumentException(Properties.Resources.InvalidPublicKey, nameof(publicKeyOrToken));
                }
            }
            else
            {
                ...
                {
                    throw new ArgumentException(Properties.Resources.InvalidSizeOfPublicKeyToken, nameof(publicKeyOrToken));
                }
            }

            if (isRetargetable && contentType == AssemblyContentType.WindowsRuntime)
            {
                throw new ArgumentException(Properties.Resources.WinRTIdentityCantBeRetargetable, nameof(isRetargetable));
            }
