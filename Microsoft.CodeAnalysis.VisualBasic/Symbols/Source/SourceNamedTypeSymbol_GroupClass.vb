                    ...
                    If haveBaseTypes Then
                        ...
                        If collectionTypes.Count > 0 Then
                            ...
                            For i As Integer = 0 To collectionTypes.Count - 1
                                ...
                                Dim mangleNames As Boolean = (i > 0 AndAlso CaseInsensitiveComparison.Equals(current.Key.Name, collectionTypes(i - 1).Key.Name)) OrElse
                                                             (i < collectionTypes.Count - 1 AndAlso CaseInsensitiveComparison.Equals(current.Key.Name, collectionTypes(i + 1).Key.Name))
