...
namespace Roslyn.Utilities
{
    public static class StringExtensions
    {
        ...
        public static bool IsValidClrTypeName([NotNullWhen(returnValue: true)] this string? name)
        {
        ...
        /// </summary>
        public static bool IsValidClrNamespaceName([NotNullWhen(returnValue: true)] this string? name)
        {
