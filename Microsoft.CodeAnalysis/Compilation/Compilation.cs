...
namespace Microsoft.CodeAnalysis
{
    ...
    public abstract partial class Compilation
    {
        ...
        protected static void ValidateScriptCompilationParameters(Compilation? previousScriptCompilation, Type? returnType, ref Type? globalsType)
        {
            ...
            {
                throw new ArgumentException(Properties.Resources.ReturnTypeCannotBeValuePointerbyRefOrOpen, nameof(globalsType));
            }

            if (returnType != null && !IsValidSubmissionReturnType(returnType))
            {
                throw new ArgumentException(Properties.Resources.ReturnTypeCannotBeVoidByRefOrOpen, nameof(returnType));
            }
            ...
            if (previousScriptCompilation != null)
            {
                ...
                {
                    throw new ArgumentException(Properties.Resources.TypeMustBeSameAsHostObjectTypeOfPreviousSubmission, nameof(globalsType));
                }
                ...
                {
                    throw new InvalidOperationException(Properties.Resources.PreviousSubmissionHasErrors);
                }
            }
        }
        ...
        protected static void CheckSubmissionOptions(CompilationOptions? options)
        {
            ...
            {
                throw new ArgumentException(Properties.Resources.InvalidOutputKindForSubmission, nameof(options));
            }
            ...
            {
                throw new ArgumentException(Properties.Resources.InvalidCompilationOptions, nameof(options));
            }
        }
        ...
        protected void CheckAssemblyName(DiagnosticBag diagnostics)
        {
        ...
        /// </summary>
        protected Type? SubmissionReturnType => ScriptCompilationInfo?.ReturnTypeOpt;
        ...
        protected abstract CommonReferenceManager CommonGetBoundReferenceManager();
        ...
        /// </summary>
        protected abstract IDictionary<(string path, string content), MetadataReference> ReferenceDirectiveMap { get; }
        ...
        public Compilation RemoveReferences(IEnumerable<MetadataReference> references)
        {
            ...
            foreach (var r in references.Distinct())
            {
                if (!refSet.Remove(r))
                {
                    throw new ArgumentException(string.Format(Properties.Resources.MetadataRefNotFoundToRemove1, r),
                                nameof(references));
                }
            }
        ...
        protected abstract CommonAnonymousTypeManager CommonAnonymousTypeManager { get; }
...
#pragma warning disable RS0026 // Do not add multiple public overloads with optional parameters
            ...
            ImmutableArray<NullableAnnotation> elementNullableAnnotations = default)
        {
            ...
            {
                throw new ArgumentException(Properties.Resources.TuplesNeedAtLeastTwoElements, nameof(elementNames));
            }
...
#pragma warning restore RS0026 // Do not add multiple public overloads with optional parameters
        ...
        protected static ImmutableArray<string?> CheckTupleElementNames(int cardinality, ImmutableArray<string?> elementNames)
        {
            if (!elementNames.IsDefault)
            {
                ...
                {
                    throw new ArgumentException(Properties.Resources.TupleElementNameCountMismatch, nameof(elementNames));
                }
                ...
                for (int i = 0; i < elementNames.Length; i++)
                {
                    if (elementNames[i] == "")
                    {
                        throw new ArgumentException(Properties.Resources.TupleElementNameEmpty, $"{nameof(elementNames)}[{i}]");
                    }
                }
...
#pragma warning restore RS0026 // Do not add multiple public overloads with optional parameters
            ...
            ImmutableArray<NullableAnnotation> memberNullableAnnotations = default)
        {
            ...
            {
                throw new ArgumentException(string.Format(Properties.Resources.AnonymousTypeMemberAndNamesCountMismatch2,
                                                    nameof(memberTypes), nameof(memberNames)));
            }

            if (!memberLocations.IsDefault && memberLocations.Length != memberTypes.Length)
            {
                throw new ArgumentException(string.Format(Properties.Resources.AnonymousTypeArgumentCountMismatch2,
            ...
            ITypeSymbol? throughType = null)
        {
            ...
            {
                throw new ArgumentException(string.Format(Properties.Resources.IsSymbolAccessibleBadWithin, nameof(within)), nameof(within));
            }
            ...
            void checkInCompilationReferences(ISymbol s, string parameterName)
            {
                ...
                {
                    throw new ArgumentException(string.Format(Properties.Resources.IsSymbolAccessibleWrongAssembly, parameterName), parameterName);
                }
            }
        ...
        protected void CompleteCompilationEventQueue_NoLock()
        {
            RoslynDebug.Assert(EventQueue != null);
        ...
        /// </summary>
        /// <returns>True if there are no unsuppressed errors (i.e., no errors which fail compilation).</returns>
        protected bool FilterAndAppendDiagnostics(DiagnosticBag accumulator, IEnumerable<Diagnostic> incoming, HashSet<int>? exclude, CancellationToken cancellationToken)
        {
            bool hasError = false;
        ...
        public void SetupWin32Resources(CommonPEModuleBuilder moduleBeingBuilt, Stream? win32Resources, bool useRawWin32Resources, DiagnosticBag diagnostics)
        {
            ...
            {
                diagnostics.Add(MessageProvider.CreateDiagnostic(MessageProvider.ERR_BadWin32Resource, NoLocation.Singleton, Properties.Resources.UnrecognizedResourceFileFormat));
                return;
            }
            catch (Exception ex)
            {
        ...
        protected bool CreateDebugDocuments(DebugDocumentsBuilder documentsBuilder, IEnumerable<EmbeddedText> embeddedTexts, DiagnosticBag diagnostics)
        {
        ...
        protected abstract Guid DebugSourceDocumentLanguageId { get; }

        protected abstract void AddDebugSourceDocumentsForChecksumDirectives(DebugDocumentsBuilder documentsBuilder, SyntaxTree tree, DiagnosticBag diagnostics);
            ...
            CancellationToken cancellationToken)
        {
            ...
            {
                throw new ArgumentException(Properties.Resources.StreamMustSupportWrite, nameof(peStream));
            }
            ...
            if (pdbStream != null)
            {
                ...
                {
                    throw new ArgumentException(Properties.Resources.PdbStreamUnexpectedWhenEmbedding, nameof(pdbStream));
                }

                if (!pdbStream.CanWrite)
                {
                    throw new ArgumentException(Properties.Resources.StreamMustSupportWrite, nameof(pdbStream));
                }

                if (options?.EmitMetadataOnly == true)
                {
                    throw new ArgumentException(Properties.Resources.PdbStreamUnexpectedWhenEmittingMetadataOnly, nameof(pdbStream));
                }
            }

            if (metadataPEStream != null && options?.EmitMetadataOnly == true)
            {
                throw new ArgumentException(Properties.Resources.MetadataPeStreamUnexpectedWhenEmittingMetadataOnly, nameof(metadataPEStream));
            }

            if (metadataPEStream != null && options?.IncludePrivateMembers == true)
            {
                throw new ArgumentException(Properties.Resources.IncludingPrivateMembersUnexpectedWhenEmittingToMetadataPeStream, nameof(metadataPEStream));
            }
            ...
            {
                throw new ArgumentException(Properties.Resources.EmbeddingPdbUnexpectedWhenEmittingMetadata, nameof(metadataPEStream));
            }
            ...
            if (this.Options.OutputKind == OutputKind.NetModule)
            {
                ...
                {
                    throw new ArgumentException(Properties.Resources.CannotTargetNetModuleWhenEmittingRefAssembly, nameof(metadataPEStream));
                }
            ...
            {
                throw new ArgumentException(Properties.Resources.StreamMustSupportRead, nameof(sourceLinkStream));
            }
            ...
            {
                throw new ArgumentException(Properties.Resources.EmbeddedTextsRequirePdb, nameof(embeddedTexts));
            }
        ...
        protected abstract EmitDifferenceResult EmitDifference(
            EmitBaseline baseline,
            IEnumerable<SemanticEdit> edits,
            Func<ISymbol, bool> isAddedSymbol,
            Stream metadataStream,
            ...
            CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                if (moduleBeingBuilt.DebugInformationFormat == DebugInformationFormat.Pdb && pdbStreamProvider != null)
                {
                    ...
                    Debug.Assert(!deterministic || moduleBeingBuilt.PdbChecksumAlgorithm != Text.SourceHashAlgorithm.None);
...
#pragma warning restore RS0026 // Do not add multiple public overloads with optional parameters
        ...
        protected bool IsMemberMissing(WellKnownMember member)
        {
        ...
        protected bool IsTypeMissing(WellKnownType type)
        {
            return IsTypeMissing((int)type);
        }
        ...
        protected abstract bool IsUnreferencedAssemblyIdentityDiagnosticCode(int code);
