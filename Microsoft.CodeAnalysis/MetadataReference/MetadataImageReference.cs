...
namespace Microsoft.CodeAnalysis
{
    ...
    internal sealed class MetadataImageReference : PortableExecutableReference
    {
        ...
        public override string Display
        {
            get
            {
                return _display ?? FilePath ?? (Properties.Kind == MetadataImageKind.Assembly ? CodeAnalysis.Properties.Resources.InMemoryAssembly : CodeAnalysis.Properties.Resources.InMemoryModule);
            }
        }
