...
#nullable enable
        ...
        {
            var declarationBinder = ContainingSymbol!.DeclaringCompilation.GetBinderFactory(syntax.SyntaxTree).GetBinder(syntax).WithAdditionalFlags(EBinder.SuppressConstraintChecks | EBinder.SuppressObsoleteChecks);
