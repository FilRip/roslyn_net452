...
namespace Microsoft.CodeAnalysis
{
    ...
    internal static class COFFResourceReader
    {
        ...
        internal static Microsoft.Cci.ResourceSection ReadWin32ResourcesFromCOFF(Stream stream)
        {
            ...
            if (foundCount != 2)
                throw new ResourceException(Properties.Resources.CoffResourceMissingSection);
            ...
            try
            {
                ...
                if (relocLastAddress > stream.Length)
                    throw new ResourceException(Properties.Resources.CoffResourceInvalidRelocation);
            }
            ...
            try
            {
                ...
                if (lastSymAddress > stream.Length)
                    throw new ResourceException(Properties.Resources.CoffResourceInvalidSymbol);
            }
            catch (OverflowException)
            {
                throw new ResourceException(Properties.Resources.CoffResourceInvalidSymbol);
