...
namespace Microsoft.Cci
{
    public sealed class PdbWriter : IDisposable
    {
        ...
        private bool IsDeterministic { get => _hashAlgorithmNameOpt != SourceHashAlgorithm.None; }
        ...
        public void SetMetadataEmitter(MetadataWriter metadataWriter)
        {
            ...
            {
                var message = IsDeterministic ? CodeAnalysis.Properties.Resources.SymWriterNotDeterministic : CodeAnalysis.Properties.Resources.SymWriterOlderVersionThanRequired;
        ...
        public void EmbedSourceLink(Stream stream)
        {
            ...
            {
                throw new SymUnmanagedWriterException(string.Format(CodeAnalysis.Properties.Resources.SymWriterDoesNotSupportSourceLink, e.ImplementationModuleName));
            }
        }
