...
Namespace Microsoft.CodeAnalysis.VisualBasic.Emit
    ...
    Partial Friend MustInherit Class PEModuleBuilder
        ...
        Public NotOverridable Overrides ReadOnly Property ModuleName As String
            Get
                Return _metadataName
            End Get
        End Property

        Public NotOverridable Overrides ReadOnly Property CorLibrary As AssemblySymbol
            Get
        ...
        Protected NotOverridable Overrides Function SynthesizeAttribute(attributeConstructor As WellKnownMember) As Cci.ICustomAttribute
        ...
        Private Function GetSmallestSourceLocationOrNull(symbol As Symbol) As Location
            ...
            For Each loc As Location In symbol.Locations
...
#End If
        ...
        Public NotOverridable Overrides Function GetSpecialType(specialType As SpecialType, syntaxNodeOpt As SyntaxNode, diagnostics As DiagnosticBag) As Cci.INamedTypeReference
        ...
        Public NotOverridable Overrides Function GetSynthesizedNestedTypes(container As NamedTypeSymbol) As IEnumerable(Of Cci.INestedTypeDefinition)
