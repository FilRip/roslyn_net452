...
namespace Internal.Cryptography
{
	internal static class RC2BCryptModes
	{
		...
		{
			SafeAlgorithmHandle safeAlgorithmHandle = Internal.NativeCrypto.Cng.BCryptOpenAlgorithmProvider("RC2", null, Internal.NativeCrypto.Cng.OpenAlgorithmProviderFlags.NONE);
