...
namespace Microsoft.CodeAnalysis
{
    ...
    public sealed class AssemblyMetadata : Metadata
    {
        ...
        public static AssemblyMetadata Create(ImmutableArray<ModuleMetadata> modules)
        {
            ...
            {
                throw new ArgumentException(Properties.Resources.AssemblyMustHaveAtLeastOneModule, nameof(modules));
            }
            ...
            for (int i = 0; i < modules.Length; i++)
            {
                ...
                {
                    throw new ArgumentException(Properties.Resources.ModuleCopyCannotBeUsedToCreateAssemblyMetadata, nameof(modules) + "[" + i + "]");
                }
            }
