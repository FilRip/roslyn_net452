...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal sealed class LoweredDynamicOperationFactory
    {
            ...
            TypeSymbol resultType)
        {
            ...
            var binderConstruction = (argumentInfoFactory is object) ? MakeBinderConstruction(WellKnownMember.Microsoft_CSharp_RuntimeBinder_Binder__UnaryOperation, new[]
            {
                // flags:
                _factory.Literal((int)binderFlags),
            ...
            TypeSymbol resultType)
        {
            ...
            MethodSymbol argumentInfoFactory = GetArgumentInfoFactory();
            var binderConstruction = (argumentInfoFactory is object) ? MakeBinderConstruction(WellKnownMember.Microsoft_CSharp_RuntimeBinder_Binder__BinaryOperation, new[]
            {
                // flags:
                _factory.Literal((int)binderFlags),
...
#nullable enable
            ...
            MethodSymbol argumentInfoFactory = GetArgumentInfoFactory();
            var binderConstruction = (argumentInfoFactory is object) ? MakeBinderConstruction(WellKnownMember.Microsoft_CSharp_RuntimeBinder_Binder__InvokeMember, new[]
            {
                // flags:
                _factory.Literal((int)binderFlags),
            ...
            bool resultDiscarded)
        {
            ...
            MethodSymbol argumentInfoFactory = GetArgumentInfoFactory();
            var binderConstruction = (argumentInfoFactory is object) ? MakeBinderConstruction(WellKnownMember.Microsoft_CSharp_RuntimeBinder_Binder__Invoke, new[]
            {
                // flags:
                _factory.Literal((int)binderFlags),
            ...
            ImmutableArray<RefKind> refKinds)
        {
            ...
            MethodSymbol argumentInfoFactory = GetArgumentInfoFactory();
            var binderConstruction = (argumentInfoFactory is object) ? MakeBinderConstruction(WellKnownMember.Microsoft_CSharp_RuntimeBinder_Binder__InvokeConstructor, new[]
            {
                // flags:
                _factory.Literal(0),
            ...
            bool resultIndexed)
        {
            ...
            MethodSymbol argumentInfoFactory = GetArgumentInfoFactory();
            var binderConstruction = (argumentInfoFactory is object) ? MakeBinderConstruction(WellKnownMember.Microsoft_CSharp_RuntimeBinder_Binder__GetMember, new[]
            {
                // flags:
                _factory.Literal((int)binderFlags),
            ...
            bool isChecked = false)
        {
            ...
            MethodSymbol argumentInfoFactory = GetArgumentInfoFactory();
            var binderConstruction = (argumentInfoFactory is object) ? MakeBinderConstruction(WellKnownMember.Microsoft_CSharp_RuntimeBinder_Binder__SetMember, new[]
            {
                // flags:
                _factory.Literal((int)binderFlags),
            ...
            ImmutableArray<RefKind> refKinds)
        {
            ...
            MethodSymbol argumentInfoFactory = GetArgumentInfoFactory();
            var binderConstruction = (argumentInfoFactory is object) ? MakeBinderConstruction(WellKnownMember.Microsoft_CSharp_RuntimeBinder_Binder__GetIndex, new[]
            {
                // flags (unused):
            ...
            bool isChecked = false)
        {
            ...
            MethodSymbol argumentInfoFactory = GetArgumentInfoFactory();
            var binderConstruction = (argumentInfoFactory is object) ? MakeBinderConstruction(WellKnownMember.Microsoft_CSharp_RuntimeBinder_Binder__SetIndex, new[]
            {
                // flags (unused):
                _factory.Literal((int)binderFlags),
