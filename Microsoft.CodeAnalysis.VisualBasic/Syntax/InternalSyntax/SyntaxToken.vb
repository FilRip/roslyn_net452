...
Namespace Microsoft.CodeAnalysis.VisualBasic.Syntax.InternalSyntax
    Partial Friend Class SyntaxToken
        ...
        Public Overrides ReadOnly Property ShouldReuseInSerialization As Boolean
            Get
        ...
        Public NotOverridable Overrides Function GetSlot(index As Integer) As GreenNode
        ...
        Public Overrides Function CreateRed(parent As SyntaxNode, position As Integer) As SyntaxNode
            Throw ExceptionUtilities.Unreachable
        End Function
    End Class
