...
Namespace Microsoft.CodeAnalysis.VisualBasic
    ...
    Partial Friend Class OverloadResolution
        ...
        Friend Shared Function GetOperatorInfo(name As String) As OperatorInfo
            ...
            If name.Length > 3 AndAlso CaseInsensitiveComparison.Equals("op_", name.Substring(0, 3)) AndAlso s_operatorNames.TryGetValue(name, result) Then
                Return result
            End If
        ...
        Shared Sub New()
            ...
            Dim operators As New Dictionary(Of String, OperatorInfo)(CaseInsensitiveComparison.Comparer) From {
