        ...
        internal static ulong ConvertEnumUnderlyingTypeToUInt64(object value, SpecialType specialType)
        {
            ...
            unchecked
            {
                return specialType switch
                {
                    ...
                    _ => throw new InvalidOperationException(string.Format("{0} is not a valid underlying type for an enum", specialType)),// not using ExceptionUtilities.UnexpectedValue() because this is used by the Services layer
