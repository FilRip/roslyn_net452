...
#pragma warning restore S3869 // "SafeHandle.DangerousGetHandle" should not be called
            ...
            for (int i = 0; i < _tableUnicodeToGBDiffs.Length; i++)
            {
                ...
                while (num2 > 0)
                {
                    map4BytesToUnicode[num] = c;
                    mapUnicodeToBytes[c] = num;
                    byte* num3 = mapUnicodeTo4BytesFlags + c / 8;
                    *num3 = (byte)(*num3 | (byte)(1 << c % 8));
                    c = (char)(c + 1);
                    num = (ushort)(num + 1);
                    num2 = (ushort)(num2 - 1);
                }
...
#pragma warning restore S2234 // Arguments should be passed in the same order as the method parameters
                    ...
                    else
                    {
                        ...
                        {
                            ushort num2 = mapUnicodeToBytes[nextChar];
                            if (Is4Byte(nextChar))
                            {
                                byte b4 = (byte)(num2 % 10 + 48);
                                num2 = (ushort)(num2 / 10);
                                byte b5 = (byte)(num2 % 126 + 129);
                                num2 = (ushort)(num2 / 126);
