...
#pragma warning restore IDE1006
        ...
        private static readonly object s_assemblyIdentityGate = new();
        ...
        internal static IAssemblyName ToAssemblyNameObject(AssemblyName name)
        {
            ...
            if (assemblyName != null)
            {
                ...
                {
#if SCRIPTING
                    throw new ArgumentException(Scripting.Properties.Resources.InvalidCharactersInAssemblyName, nameof(name));
...
#else
                    throw new ArgumentException(CodeAnalysisResources.InvalidCharactersInAssemblyName, nameof(name));
#endif
                }
            ...
            if (cultureName != null)
            {
                ...
                {
#if SCRIPTING
                    throw new ArgumentException(Microsoft.CodeAnalysis.Scripting.Properties.Resources.InvalidCharactersInAssemblyName, nameof(name));
#elif EDITOR_FEATURES
                    throw new ArgumentException(Microsoft.CodeAnalysis.Editor.EditorFeaturesResources.Invalid_characters_in_assembly_name, nameof(name));
#else
