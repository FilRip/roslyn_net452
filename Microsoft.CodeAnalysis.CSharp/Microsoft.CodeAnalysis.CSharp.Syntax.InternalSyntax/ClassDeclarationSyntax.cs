...
namespace Microsoft.CodeAnalysis.CSharp.Syntax.InternalSyntax
{
    public sealed class ClassDeclarationSyntax : TypeDeclarationSyntax
    {
        ...
        {
            return new ClassDeclarationSyntax(base.Kind, attributeLists, modifiers, keyword, identifier, typeParameterList, baseList, constraintClauses, openBraceToken, members, closeBraceToken, semicolonToken, diagnostics, GetAnnotations());
        }

        public override GreenNode SetAnnotations(SyntaxAnnotation[]? annotations)
        {
            return new ClassDeclarationSyntax(base.Kind, attributeLists, modifiers, keyword, identifier, typeParameterList, baseList, constraintClauses, openBraceToken, members, closeBraceToken, semicolonToken, GetDiagnostics(), annotations);
        }

        public ClassDeclarationSyntax(ObjectReader reader)
            : base(reader)
        {
            base.SlotCount = 11;
        ...
        {
            ObjectBinder.RegisterTypeReader(typeof(ClassDeclarationSyntax), (ObjectReader r) => new ClassDeclarationSyntax(r));
        }
    }
}
