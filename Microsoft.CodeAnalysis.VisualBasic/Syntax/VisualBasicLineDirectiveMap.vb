...
Namespace Microsoft.CodeAnalysis.VisualBasic.Syntax
    ...
    Friend Class VisualBasicLineDirectiveMap
        ...
        Public Overrides Function TranslateSpanAndVisibility(sourceText As SourceText, treeFilePath As String, span As TextSpan, ByRef isHiddenPosition As Boolean) As FileLinePositionSpan
