...
Namespace Microsoft.CodeAnalysis.VisualBasic
	Friend NotInheritable Class StringConstants
		...
		Friend Const HoistedSpecialVariablePrefix As String = "$VB$NonLocal_"
		...
		Friend Const DelegateRelaxationDisplayClassPrefix As String = "_Closure$__R"

		Friend Const DelegateRelaxationMethodNamePrefix As String = "_Lambda$__R"
		...
		Friend Const StaticLocalFieldNamePrefix As String = "$STATIC$"
