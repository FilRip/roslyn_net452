...
#End Region
        ...
        Friend Overrides Function MakeDeclaredInterfaces(basesBeingResolved As BasesBeingResolved, diagnostics As BindingDiagnosticBag) As ImmutableArray(Of NamedTypeSymbol)
            Try
                ...
                For Each interfaceImpl In interfaceImpls
                    ...
                    symbols(i) = If(namedTypeSymbol, New UnsupportedMetadataTypeSymbol()) ' "interface tmpList contains a bad type"
                    i += 1
                Next
        ...
        Private Function CreateNestedTypes() As Dictionary(Of String, ImmutableArray(Of PENamedTypeSymbol))
            ...
            Dim children = members.GroupBy(Function(t) t.Name, CaseInsensitiveComparison.Comparer)
            Dim types = New Dictionary(Of String, ImmutableArray(Of PENamedTypeSymbol))(CaseInsensitiveComparison.Comparer)
                ...
                For Each fieldDef In [module].GetFieldsOfTypeOrThrow(_handle)
                    ...
                    If [module].HasAccessedThroughPropertyAttribute(fieldDef, witheventPropertyName) Then
                        ...
                        If witheventPropertyNames Is Nothing Then
                            witheventPropertyNames = New HashSet(Of String)(CaseInsensitiveComparison.Comparer)
                        End If
