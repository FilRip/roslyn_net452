...
namespace Microsoft.CodeAnalysis
{
    ...
    public abstract class MetadataReference
    {
            ...
            DocumentationProvider? documentation = null)
        {
            ...
            {
                throw new NotSupportedException(CodeAnalysis.Properties.Resources.CantCreateReferenceToDynamicAssembly);
            }

            if (properties.Kind != MetadataImageKind.Assembly)
            {
                throw new ArgumentException(CodeAnalysis.Properties.Resources.CantCreateModuleReferenceToAssembly, nameof(properties));
            }

            string location = assembly.Location;
            if (string.IsNullOrEmpty(location))
            {
                throw new NotSupportedException(CodeAnalysis.Properties.Resources.CantCreateReferenceToAssemblyWithoutLocation);
            }
