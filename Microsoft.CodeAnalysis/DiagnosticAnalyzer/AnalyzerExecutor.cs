...
namespace Microsoft.CodeAnalysis.Diagnostics
{
    ...
    /// </summary>
    public partial class AnalyzerExecutor
    {
        ...
        internal static Diagnostic CreateAnalyzerExceptionDiagnostic(DiagnosticAnalyzer analyzer, Exception e, AnalysisContextInfo? info = null)
        {
            ...
            var title = Properties.Resources.CompilerAnalyzerFailure;
            var messageFormat = Properties.Resources.CompilerAnalyzerThrows;
            ...
            var description = string.Format(Properties.Resources.CompilerAnalyzerThrowsDescription, analyzerName, CreateDiagnosticDescription(info, e));
        ...
        private static string CreateDiagnosticDescription(AnalysisContextInfo? info, Exception e)
        {
            ...
            return string.Join(Environment.NewLine,
                string.Format(Properties.Resources.ExceptionContext, info?.GetContext()), e.CreateDiagnosticDescription());
        }
        ...
        private static string CreateDisablingMessage(DiagnosticAnalyzer analyzer)
        {
            ...
            return string.Format(Properties.Resources.DisableAnalyzerDiagnosticsMessage, string.Join(", ", diagnosticIds));
        }

        internal static Diagnostic CreateDriverExceptionDiagnostic(Exception e)
        {
            var title = Properties.Resources.AnalyzerDriverFailure;
            var messageFormat = Properties.Resources.AnalyzerDriverThrows;
            var messageArguments = new[] { e.GetType().ToString(), e.Message };
            var description = string.Format(Properties.Resources.AnalyzerDriverThrowsDescription, e.CreateDiagnosticDescription());
        ...
        internal static DiagnosticDescriptor GetAnalyzerExceptionDiagnosticDescriptor(string? id = null, string? title = null, string? description = null, string? messageFormat = null)
        {
            ...
            title ??= Properties.Resources.CompilerAnalyzerFailure;
            messageFormat ??= Properties.Resources.CompilerAnalyzerThrows;
            description ??= Properties.Resources.CompilerAnalyzerFailure;
