...
Namespace Microsoft.CodeAnalysis.VisualBasic.Emit.NoPia
    ...
    Friend NotInheritable Class EmbeddedTypesManager
        ...
        Public Overrides Function GetTargetAttributeSignatureIndex(underlyingSymbol As SymbolAdapter, attrData As VisualBasicAttributeData, description As AttributeDescription) As Integer
            Return attrData.GetTargetAttributeSignatureIndex(underlyingSymbol.AdaptedSymbol, description)
        End Function

        Public Overrides Function CreateSynthesizedAttribute(constructor As WellKnownMember, attrData As VisualBasicAttributeData, syntaxNodeOpt As SyntaxNode, diagnostics As DiagnosticBag) As VisualBasicAttributeData
        ...
        Public Overrides Sub ReportIndirectReferencesToLinkedAssemblies(assembly As AssemblySymbol, diagnostics As DiagnosticBag)
...
checksForAllEmbedabbleTypes:
        ...
        Public Overrides Function EmbedField(
        ...
        Public Overrides Function EmbedMethod(
            type As EmbeddedType,
        ...
        Public Overrides Function EmbedProperty(
            type As EmbeddedType,
        ...
        Public Overrides Function EmbedEvent(
            type As EmbeddedType,
