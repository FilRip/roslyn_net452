...
namespace System
{
    public static class AppContext
    {
        ...
        private static readonly Dictionary<string, SwitchValueState> s_switchMap = new();
        ...
        public static bool TryGetSwitch(string switchName, out bool isEnabled)
        {
            ...
            {
                throw new ArgumentException(SystemExtensions.Properties.Resources.Argument_EmptyName, "switchName");
            }
            if (!s_defaultsInitialized)
            {
