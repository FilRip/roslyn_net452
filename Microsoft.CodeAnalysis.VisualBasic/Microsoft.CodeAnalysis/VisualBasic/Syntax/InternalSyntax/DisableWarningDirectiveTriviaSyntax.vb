...
Namespace Microsoft.CodeAnalysis.VisualBasic.Syntax.InternalSyntax
	Friend NotInheritable Class DisableWarningDirectiveTriviaSyntax
		...
		Friend ReadOnly Property DisableKeyword As KeywordSyntax
			Get
		...
		Shared Sub New()
			Microsoft.CodeAnalysis.VisualBasic.Syntax.InternalSyntax.DisableWarningDirectiveTriviaSyntax.CreateInstance = Function(o As ObjectReader) New Microsoft.CodeAnalysis.VisualBasic.Syntax.InternalSyntax.DisableWarningDirectiveTriviaSyntax(o)
			ObjectBinder.RegisterTypeReader(GetType(Microsoft.CodeAnalysis.VisualBasic.Syntax.InternalSyntax.DisableWarningDirectiveTriviaSyntax), Function(r As ObjectReader) New Microsoft.CodeAnalysis.VisualBasic.Syntax.InternalSyntax.DisableWarningDirectiveTriviaSyntax(r))
		End Sub

		Friend Sub New(ByVal kind As SyntaxKind, ByVal hashToken As PunctuationSyntax, ByVal disableKeyword As KeywordSyntax, ByVal warningKeyword As KeywordSyntax, ByVal errorCodes As GreenNode)
			MyBase.New(kind, hashToken)
			MyBase._slotCount = 4
			MyBase.AdjustFlagsAndWidth(disableKeyword)
		...
		Friend Sub New(ByVal kind As SyntaxKind, ByVal hashToken As PunctuationSyntax, ByVal disableKeyword As KeywordSyntax, ByVal warningKeyword As KeywordSyntax, ByVal errorCodes As GreenNode, ByVal context As ISyntaxFactoryContext)
			MyBase.New(kind, hashToken)
			MyBase._slotCount = 4
		...
		Friend Sub New(ByVal kind As SyntaxKind, ByVal errors As DiagnosticInfo(), ByVal annotations As SyntaxAnnotation(), ByVal hashToken As PunctuationSyntax, ByVal disableKeyword As KeywordSyntax, ByVal warningKeyword As KeywordSyntax, ByVal errorCodes As GreenNode)
		...
		Friend Sub New(ByVal reader As ObjectReader)
			...
			If (keywordSyntax IsNot Nothing) Then
				...
				Me._disableKeyword = keywordSyntax
			End If
		...
		Friend Overrides Function SetAnnotations(ByVal annotations As SyntaxAnnotation()) As GreenNode
			Return New Microsoft.CodeAnalysis.VisualBasic.Syntax.InternalSyntax.DisableWarningDirectiveTriviaSyntax(MyBase.Kind, MyBase.GetDiagnostics(), annotations, Me._hashToken, Me._disableKeyword, Me._warningKeyword, Me._errorCodes)
		End Function

		Friend Overrides Function SetDiagnostics(ByVal newErrors As DiagnosticInfo()) As GreenNode
			Return New Microsoft.CodeAnalysis.VisualBasic.Syntax.InternalSyntax.DisableWarningDirectiveTriviaSyntax(MyBase.Kind, newErrors, MyBase.GetAnnotations(), Me._hashToken, Me._disableKeyword, Me._warningKeyword, Me._errorCodes)
		End Function

		Friend Overrides Sub WriteTo(ByVal writer As ObjectWriter)
			MyBase.WriteTo(writer)
			writer.WriteValue(DirectCast(Me._disableKeyword, IObjectWritable))
