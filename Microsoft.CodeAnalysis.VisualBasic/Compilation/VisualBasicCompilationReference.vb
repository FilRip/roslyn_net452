...
Namespace Microsoft.CodeAnalysis.VisualBasic
    ...
    Friend NotInheritable Class VisualBasicCompilationReference
        ...
        Public Overrides ReadOnly Property CompilationCore As Compilation
            Get
                Return _compilation
            End Get
        End Property
...
#End If
        ...
        Public Overrides Function WithPropertiesImpl(properties As MetadataReferenceProperties) As CompilationReference
            Return New VisualBasicCompilationReference(_compilation, properties)
        End Function

        Private Function GetDebuggerDisplay() As String
            Return My.Resources.CompilationVisualBasic + _compilation.AssemblyName
        End Function
    End Class
End Namespace
