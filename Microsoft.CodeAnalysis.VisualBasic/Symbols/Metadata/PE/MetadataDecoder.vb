...
Namespace Microsoft.CodeAnalysis.VisualBasic.Symbols.Metadata.PE
    ...
    Friend Class MetadataDecoder
        ...
        Public Overrides Function GetSymbolForMemberRef(memberRef As MemberReferenceHandle, Optional scope As TypeSymbol = Nothing, Optional methodsOnly As Boolean = False) As Symbol
