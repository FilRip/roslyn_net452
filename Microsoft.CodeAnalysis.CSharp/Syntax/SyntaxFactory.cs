        ...
        public static SyntaxToken Token(SyntaxTriviaList leading, SyntaxKind kind, string text, string valueText, SyntaxTriviaList trailing)
        {
            switch (kind)
            {
                case SyntaxKind.IdentifierToken:
                    ...
                    throw new ArgumentException(Properties.Resources.UseVerbatimIdentifier, nameof(kind));
                case SyntaxKind.CharacterLiteralToken:
                    // Value should not have type string.
                    throw new ArgumentException(Properties.Resources.UseLiteralForTokens, nameof(kind));
                case SyntaxKind.NumericLiteralToken:
                    // Value should not have type string.
                    throw new ArgumentException(Properties.Resources.UseLiteralForNumeric, nameof(kind));
            }

            if (!SyntaxFacts.IsAnyToken(kind))
            {
                throw new ArgumentException(string.Format(Properties.Resources.ThisMethodCanOnlyBeUsedToCreateTokens, kind), nameof(kind));
            }
...
#pragma warning restore RS0026 // Do not add multiple public overloads with optional parameters
        ...
        internal static CrefSyntax? ParseCref(string text)
        {
            ...
            XmlAttributeSyntax attributeSyntax = elementSyntax.Attributes[0];
        ...
        public static bool IsCompleteSubmission(SyntaxTree tree)
        {
            ...
            {
                throw new ArgumentException(Properties.Resources.SyntaxTreeIsNotASubmission);
            }
