    ...
    internal static class SegmentedArray
    {
        ...
        internal static void Copy<T>(SegmentedArray<T> sourceArray, SegmentedArray<T> destinationArray, int length)
        {
            ...
            if (length > sourceArray.Length)
                throw new ArgumentException(Properties.Resources.Arg_LongerThanSrcArray, nameof(sourceArray));
            if (length > destinationArray.Length)
                throw new ArgumentException(Properties.Resources.Arg_LongerThanDestArray, nameof(destinationArray));
        ...
        {
            if (length < 0)
                throw new ArgumentOutOfRangeException(nameof(length), Properties.Resources.ArgumentOutOfRange_NeedNonNegNum);
            if (sourceIndex < 0)
                throw new ArgumentOutOfRangeException(nameof(sourceIndex), Properties.Resources.ArgumentOutOfRange_ArrayLB);
            if (destinationIndex < 0)
                throw new ArgumentOutOfRangeException(nameof(destinationIndex), Properties.Resources.ArgumentOutOfRange_ArrayLB);
        ...
        public static void Copy<T>(SegmentedArray<T> sourceArray, int sourceIndex, Array destinationArray, int destinationIndex, int length)
        {
            ...
            if (typeof(T[]) != destinationArray.GetType() && destinationArray.Rank != 1)
                throw new RankException(Properties.Resources.Rank_MustMatch);
