...
namespace Microsoft.CodeAnalysis.CodeGen
{
    public partial class ILBuilder
    {
        ...
        public void EmitToken(Cci.IReference value, SyntaxNode syntaxNode, DiagnosticBag diagnostics, bool encodeAsRawToken = false)
        {
        ...
        public void EmitToken(Cci.ISignature value, SyntaxNode syntaxNode, DiagnosticBag diagnostics)
        {
            uint token = module?.GetFakeSymbolTokenForIL(value, syntaxNode, diagnostics) ?? 0xFFFF;
            this.GetCurrentWriter().WriteUInt32(token);
        }
        ...
        public void EmitSourceDocumentIndexToken(Cci.DebugSourceDocument document)
        {
