...
namespace Microsoft.CodeAnalysis.Diagnostics
{
    ...
    public abstract class OperationBlockStartAnalysisContext
    {
        ...
        public ControlFlowGraph GetControlFlowGraph(IOperation operationBlock)
        {
            ...
            {
                throw new ArgumentException(Properties.Resources.InvalidOperationBlockForAnalysisContext, nameof(operationBlock));
            }
    ...
    public struct SuppressionAnalysisContext
    {
        ...
        public void ReportSuppression(Suppression suppression)
        {
            if (!ReportedDiagnostics.Contains(suppression.SuppressedDiagnostic))
            {
                ...
                var message = string.Format(Properties.Resources.NonReportedDiagnosticCannotBeSuppressed, suppression.SuppressedDiagnostic.Id);
            ...
            if (!_isSupportedSuppressionDescriptor(suppression.Descriptor))
            {
                ...
                var message = string.Format(Properties.Resources.UnsupportedSuppressionReported, suppression.Descriptor.Id);
                throw new ArgumentException(message);
            }
