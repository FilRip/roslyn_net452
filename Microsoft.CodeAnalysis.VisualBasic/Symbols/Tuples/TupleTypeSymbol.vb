    ...
    Friend NotInheritable Class TupleTypeSymbol
        ...
        Friend Shared Function IsElementNameReserved(name As String) As Integer
            ...
            If TupleTypeSymbol.IsElementNameForbidden(name) Then
                result = 0
            Else
                If CaseInsensitiveComparison.StartsWith(name, "Item") Then
                    Dim s As String = name.Substring(4)
                    Dim num As Integer

                    If Integer.TryParse(s, num) Then
                        If num > 0 AndAlso CaseInsensitiveComparison.Equals(name, TupleTypeSymbol.TupleMemberName(num)) Then
                            result = num
                            Return result
                        End If
                    End If
                    ...
                    Select Case member.Kind
                        ...
                        Case SymbolKind.Field
                            ...
                            If tupleFieldIndex >= 0 Then
                                ...
                                Else
                                    Debug.Assert(CaseInsensitiveComparison.Equals(FieldSymbol.Name, defaultName), "top level underlying field must match default name")
        ...
        Public Overrides Function GetMembers(name As String) As ImmutableArray(Of Symbol)
            Return Me.GetMembers().WhereAsArray(Function(member, name_) CaseInsensitiveComparison.Equals(member.Name, name_), name)
        End Function
        ...
        Public Overrides Function Equals(obj As TypeSymbol, comparison As TypeCompareKind) As Boolean
            ...
            If (comparison And TypeCompareKind.IgnoreTupleNames) = 0 Then
                ...
                For i As Integer = 0 To myNames.Length - 1
                    If Not CaseInsensitiveComparison.Equals(myNames(i), otherNames(i)) Then
                        Return False
                    End If
                Next
            End If
