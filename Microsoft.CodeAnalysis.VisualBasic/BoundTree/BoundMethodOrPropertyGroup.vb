            ...
            Get
                ...
                Select Case Me.Kind
                    Case BoundKind.MethodGroup
                        ...
                        Debug.Assert(methods.All(Function(m) CaseInsensitiveComparison.Comparer.Compare(m.Name, name) = 0))
                        Return name
                    ...
                    Case BoundKind.PropertyGroup
                        ...
                        Debug.Assert(properties.All(Function(m) CaseInsensitiveComparison.Comparer.Compare(m.Name, name) = 0))
                        Return name
                End Select
