...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    internal static partial class EnumConversions
    {
        internal static TypeKind ToTypeKind(this DeclarationKind kind)
        {
            return kind switch
            {
                DeclarationKind.Class or DeclarationKind.Script or DeclarationKind.ImplicitClass or DeclarationKind.SimpleProgram or DeclarationKind.Record => TypeKind.Class,
