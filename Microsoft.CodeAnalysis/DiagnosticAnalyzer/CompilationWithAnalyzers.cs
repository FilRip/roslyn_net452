    ...
    public class CompilationWithAnalyzers
    {
        ...
        private static void VerifyAnalyzersArgumentForStaticApis(ImmutableArray<DiagnosticAnalyzer> analyzers, bool allowDefaultOrEmpty = false)
        {
            if (analyzers.IsDefaultOrEmpty)
            {
                ...
                throw new ArgumentException(Properties.Resources.ArgumentCannotBeEmpty, nameof(analyzers));
            }

            if (analyzers.Any(a => a == null))
            {
                throw new ArgumentException(Properties.Resources.ArgumentElementCannotBeNull, nameof(analyzers));
            }

            if (analyzers.Distinct().Length != analyzers.Length)
            {
                // Has duplicate analyzer instances.
                throw new ArgumentException(Properties.Resources.DuplicateAnalyzerInstances, nameof(analyzers));
            }
        }
        ...
        private void VerifyAnalyzerArgument(DiagnosticAnalyzer analyzer)
        {
            ...
            {
                throw new ArgumentException(Properties.Resources.UnsupportedAnalyzerInstance, nameof(analyzer));
            }
        }
        ...
        private static void VerifyAnalyzerArgumentForStaticApis(DiagnosticAnalyzer analyzer)
        {
            if (analyzer == null)
            {
                throw new ArgumentException(Properties.Resources.ArgumentCannotBeEmpty, nameof(analyzer));
            }
        }
        ...
        private void VerifyExistingAnalyzersArgument(ImmutableArray<DiagnosticAnalyzer> analyzers)
        {
            ...
            {
                throw new ArgumentException(Properties.Resources.UnsupportedAnalyzerInstance, nameof(_analyzers));
            }
        ...
        private void VerifyModel(SemanticModel model)
        {
            ...
            {
                throw new ArgumentException(Properties.Resources.InvalidTree, nameof(model));
            }
        }
        ...
        private void VerifyTree(SyntaxTree tree)
        {
            ...
            {
                throw new ArgumentException(Properties.Resources.InvalidTree, nameof(tree));
            }
        }
        ...
        private void VerifyAdditionalFile(AdditionalText file)
        {
            ...
            {
                throw new ArgumentException(Properties.Resources.InvalidAdditionalFile, nameof(file));
            }
        }
