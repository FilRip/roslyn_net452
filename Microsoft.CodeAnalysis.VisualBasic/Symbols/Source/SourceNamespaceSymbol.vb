    ...
    Friend NotInheritable Class SourceNamespaceSymbol
        ...
        Private Structure NameToSymbolMapBuilder
            ...
            Public Function CreateMap() As Dictionary(Of String, ImmutableArray(Of NamespaceOrTypeSymbol))
                Dim result As New Dictionary(Of String, ImmutableArray(Of NamespaceOrTypeSymbol))(Me._dictionary.Count, CaseInsensitiveComparison.Comparer)
...
#End If
        ...
        Friend Function GetDeclarationSpelling(tree As SyntaxTree, location As Integer) As String
            ...
            Else
                ...
                Debug.Assert(CaseInsensitiveComparison.Equals(fullDeclName, ToDisplayString(SymbolDisplayFormat.QualifiedNameOnlyFormat)))
                Return fullDeclName
            End If
        End Function
