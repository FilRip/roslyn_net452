...
namespace System.Text
{
	internal class SBCSCodePageEncoding : BaseCodePageEncoding
	{
		...
		public unsafe override int GetChars(byte* bytes, int byteCount, char* chars, int charCount, DecoderNLS decoder)
		{
			...
			DecoderFallbackBufferHelper decoderFallbackBufferHelper = new DecoderFallbackBufferHelper((decoder != null) ? decoder.FallbackBuffer : base.DecoderFallback.CreateFallbackBuffer());
			while (bytes < ptr)
			{
