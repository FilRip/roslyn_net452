...
namespace Microsoft.CodeAnalysis
{
    ...
    public sealed class EmbeddedText
    {
        ...
        public static EmbeddedText FromSource(string filePath, SourceText text)
        {
            ...
            {
                throw new ArgumentException(Properties.Resources.SourceTextCannotBeEmbedded, nameof(text));
            }
        ...
        private static void ValidateFilePath(string filePath)
        {
            ...
            {
                throw new ArgumentException(Properties.Resources.ArgumentCannotBeEmpty, nameof(filePath));
            }
        }
