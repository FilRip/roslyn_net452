    ...
    public sealed partial class ObjectReader : IDisposable
    {
        ...
        private object ReadValueWorker()
        {
            ...
            return kind switch
            {
                ...
                EncodingKind.Int32_0 or EncodingKind.Int32_1 or EncodingKind.Int32_2 or EncodingKind.Int32_3 or EncodingKind.Int32_4 or EncodingKind.Int32_5 or EncodingKind.Int32_6 or EncodingKind.Int32_7 or EncodingKind.Int32_8 or EncodingKind.Int32_9 or EncodingKind.Int32_10 => (int)kind - (int)EncodingKind.Int32_0,
                ...
                EncodingKind.UInt32_0 or EncodingKind.UInt32_1 or EncodingKind.UInt32_2 or EncodingKind.UInt32_3 or EncodingKind.UInt32_4 or EncodingKind.UInt32_5 or EncodingKind.UInt32_6 or EncodingKind.UInt32_7 or EncodingKind.UInt32_8 or EncodingKind.UInt32_9 or EncodingKind.UInt32_10 => (uint)((int)kind - (int)EncodingKind.UInt32_0),
                ...
                EncodingKind.Char => (char)_reader.ReadUInt16(),// read as ushort because BinaryWriter fails on chars that are unicode surrogates
                EncodingKind.StringUtf8 or EncodingKind.StringUtf16 or EncodingKind.StringRef_4Bytes or EncodingKind.StringRef_1Byte or EncodingKind.StringRef_2Bytes => ReadStringValue(kind),
                ...
                EncodingKind.Array or EncodingKind.Array_0 or EncodingKind.Array_1 or EncodingKind.Array_2 or EncodingKind.Array_3 => ReadArray(kind),
        ...
        {
            return new InvalidOperationException(string.Format(Microsoft.CodeAnalysis.Properties.Resources.The_type_0_is_not_understood_by_the_serialization_binder, typeName));
        }

        private static Exception NoSerializationReaderException(string typeName)
        {
            return new InvalidOperationException(string.Format(Microsoft.CodeAnalysis.Properties.Resources.Cannot_serialize_type_0, typeName));
        }
    }
}
