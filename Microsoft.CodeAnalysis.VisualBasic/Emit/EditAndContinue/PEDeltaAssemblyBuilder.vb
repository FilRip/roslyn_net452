...
Namespace Microsoft.CodeAnalysis.VisualBasic.Emit
    ...
    Friend NotInheritable Class PEDeltaAssemblyBuilder
        ...
        Public Overrides Function EncTranslateLocalVariableType(type As TypeSymbol, diagnostics As DiagnosticBag) As ITypeReference
        ...
        Public Overrides ReadOnly Property SupportsPrivateImplClass As Boolean
            Get
