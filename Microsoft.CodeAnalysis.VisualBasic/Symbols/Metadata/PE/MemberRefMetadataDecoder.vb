        ...
        Protected Overrides Function GetGenericTypeParamSymbol(position As Integer) As TypeSymbol
            ...
            If peType IsNot Nothing Then
                ...
                If peType Is Nothing OrElse peType.MetadataArity <= position Then
                    Return New UnsupportedMetadataTypeSymbol(My.Resources.PositionOfTypeParameterTooLarge)
                End If
            ...
            Return New UnsupportedMetadataTypeSymbol(My.Resources.AssociatedTypeDoesNotHaveTypeParameters)
        End Function
