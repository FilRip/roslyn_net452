...
namespace Microsoft.CodeAnalysis
{
    public partial class DocumentationProvider
    {
        ...
        {
            public override string GetDocumentationForSymbol(string documentationMemberID, CultureInfo preferredCulture, CancellationToken cancellationToken = default)
            {
                return "";
            }
