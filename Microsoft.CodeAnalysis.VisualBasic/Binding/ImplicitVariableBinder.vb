...
#End If
            ...
            If _implicitLocals Is Nothing Then
                _implicitLocals = New Dictionary(Of String, LocalSymbol)(CaseInsensitiveComparison.Comparer)
            End If
...
#End If
            ...
            If _possiblyShadowingVariables Is Nothing Then
                _possiblyShadowingVariables = New MultiDictionary(Of String, ShadowedVariableInfo)(CaseInsensitiveComparison.Comparer)
            End If
