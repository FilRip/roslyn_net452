    ...
    public sealed class PEModule : IDisposable
    {
        ...
        private unsafe void InitializeMetadataReader()
        {
            ...
            else
            {
                ...
                if (!hasMetadata)
                {
                    throw new BadImageFormatException(Properties.Resources.PEImageDoesntContainManagedMetadata);
                }
        ...
        internal ImmutableArray<string> GetMetadataModuleNamesOrThrow()
        {
            ...
            try
            {
                foreach (var fileHandle in MetadataReader.AssemblyFiles)
                {
                    ...
                    {
                        throw new BadImageFormatException(string.Format(Properties.Resources.InvalidModuleName, this.Name, moduleName));
                    }
