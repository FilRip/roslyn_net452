...
namespace Microsoft.CodeAnalysis
{
    public static class MetadataHelpers
    {
        ...
        private static string GetAssemblyOrModuleNameErrorArgumentResourceName(string name)
        {
            if (name == null)
            {
                return nameof(Properties.Resources.NameCannotBeNull);
            }
            ...
            if (name.Length == 0)
            {
                return nameof(Properties.Resources.NameCannotBeEmpty);
            }
            ...
            {
                return nameof(Properties.Resources.NameCannotStartWithWhitespace);
            }

            if (!IsValidMetadataFileName(name))
            {
                return nameof(Properties.Resources.NameContainsInvalidCharacter);
            }
