...
namespace Microsoft.CodeAnalysis
{
    ...
    public sealed class SuppressionDescriptor : IEquatable<SuppressionDescriptor?>
    {
            ...
            LocalizableString justification)
        {
            ...
            {
                throw new ArgumentException(Properties.Resources.SuppressionIdCantBeNullOrWhitespace, nameof(id));
            }

            if (string.IsNullOrWhiteSpace(suppressedDiagnosticId))
            {
                throw new ArgumentException(Properties.Resources.DiagnosticIdCantBeNullOrWhitespace, nameof(suppressedDiagnosticId));
            }
