...
namespace Microsoft.CodeAnalysis.Text
{
    ...
    public abstract class SourceText
    {
        ...
        protected SourceText(ImmutableArray<byte> checksum = default, SourceHashAlgorithm checksumAlgorithm = SourceHashAlgorithm.Sha1, SourceTextContainer? container = null)
        {
            ...
            {
                throw new ArgumentException(Properties.Resources.InvalidHash, nameof(checksum));
            }
        ...
        internal static void ValidateChecksumAlgorithm(SourceHashAlgorithm checksumAlgorithm)
        {
            ...
            {
                throw new ArgumentException(Properties.Resources.UnsupportedHashAlgorithm, nameof(checksumAlgorithm));
            }
        }
            ...
            bool canBeEmbedded = false)
        {
            ...
            if (!stream.CanRead)
            {
                throw new ArgumentException(Properties.Resources.StreamMustSupportReadAndSeek, nameof(stream));
            }
            ...
            try
            {
                ...
                foreach (var change in changes)
                {
                    if (change.Span.End > this.Length)
                        throw new ArgumentException(Properties.Resources.ChangesMustBeWithinBoundsOfSourceText, nameof(changes));
                    ...
                    if (change.Span.Start < position)
                    {
                        ...
                        throw new ArgumentException(Properties.Resources.ChangesMustNotOverlap, nameof(changes));
                    }
